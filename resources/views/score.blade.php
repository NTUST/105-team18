        ...
        <div class="col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="col-xs-2">
                        <button type="button" id="score-btn-{{$i}}" class="btn btn-primary btn-block" data-toggle="modal" data-target="#ScoreModal{{$i}}" >評分</button>
                        <!-- Modal -->
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <script type="text/javascript">
                                        $(function(){
                                            var isScored{{$i}} = {{$scoreData[$i]['isScored']}};

                                          

                                        
                                        $("#Score-layout-"+{{$i}}).raty({score:{{$scoreData[$i]['score'][0]}}});
                                        $("#Score-design-"+{{$i}}).raty({score:{{$scoreData[$i]['score'][1]}}});
                                        $("#Score-technology-"+{{$i}}).raty({score:{{$scoreData[$i]['score'][2]}}});
                                        $("#Score-idea-"+{{$i}}).raty({score:{{$scoreData[$i]['score'][3]}}});
                                        $("#Score-other-"+{{$i}}).raty({score:{{$scoreData[$i]['score'][4]}}});
                                        ...
                                        if(isScored{{$i}} == 1){
                                            $("#Confirm-btn-"+{{$i}}).remove();
                                            $("#score-btn-"+{{$i}}).html("查看評分").removeClass('btn-primary').addClass('btn-success');
                                        }
